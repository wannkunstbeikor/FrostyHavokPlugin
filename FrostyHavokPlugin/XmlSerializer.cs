...
public class XmlSerializer
{
    ...
    public XElement WriteQSTransform(XElement xe, string paramName, Matrix4 value)
    {
    ...
    public XElement WriteMatrix4(XElement xe, string paramName, Matrix4 value)
    {
        // TODO: verify
    ...
    public XElement WriteTransform(XElement xe, string paramName, Matrix4 value)
    {
