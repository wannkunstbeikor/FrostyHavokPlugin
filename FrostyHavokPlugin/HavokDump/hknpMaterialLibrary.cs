...
public class hknpMaterialLibrary : hkReferencedObject
{
    ...
    {
        return obj is hknpMaterialLibrary other && base.Equals(other) && _entries == other._entries && Signature == other.Signature;
    }
    public static bool operator ==(hknpMaterialLibrary? a, object? b) => a?.Equals(b) ?? b is null;
    public static bool operator !=(hknpMaterialLibrary? a, object? b) => !(a == b);
